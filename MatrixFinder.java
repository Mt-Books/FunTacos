...
*      (aka col--;)
*    - If it isn't > or <, then the current number must be equal to target. Return
*      the current index (row, col)
* If at any point the index for row or column gets out of the range of the matrix,
* the while loop ends and (-1,-1) is returned, meaning that the target is not in 
* the matrix.
****************************** */
